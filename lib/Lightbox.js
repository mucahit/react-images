...
var ReactSpinners = _interopRequireWildcard(_reactSpinners);
...
var Lightbox = function (_Component) {
	...
	function Lightbox(props) {
		...
		_bindFunctions2.default.call(_this, ['gotoNext', 'gotoPrev', 'rotate', 'zoom', 'closeBackdrop', 'handleKeyboardInput', 'handleImageLoaded']);
		return _this;
	}
	...
	_createClass(Lightbox, [{
		...
		value: function renderImages() {
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					'div',
					{ className: (0, _aphrodite.css)(this.classes.imageWrapper) },
					...
					this.props.content ? _react2.default.createElement(
						'figcaption',
						{
							className: (0, _aphrodite.css)(this.classes.figcaption),
							style: {
		...
		get: function get() {
			...
			return _aphrodite.StyleSheet.create((0, _deepMerge2.default)(defaultStyles, this.theme));
		}
	}]);
...
var DefaultSpinner = function DefaultSpinner(props) {
	return _react2.default.createElement(ReactSpinners.BounceLoader, props);
};
