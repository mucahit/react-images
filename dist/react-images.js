(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('react'), require('prop-types'), require('aphrodite'), require('react-scrolllock'), require('aphrodite/no-important'), require('react-transition-group'), require('react-dom')) :
	typeof define === 'function' && define.amd ? define(['react', 'prop-types', 'aphrodite', 'react-scrolllock', 'aphrodite/no-important', 'react-transition-group', 'react-dom'], factory) :
	(global.Lightbox = factory(global.React,global.PropTypes,global.aphrodite,global.ScrollLock,global.aphrodite,global.ReactTransitionGroup,global.ReactDOM));
}(this, (function (React,PropTypes,aphrodite,ScrollLock,noImportant,reactTransitionGroup,reactDom) { 'use strict';
	...
	createClass(Lightbox, [{
		...
		value: function componentDidMount() {
			...
			if (this.props.zoom) {
				document.addEventListener('mousemove', function (event) {
					...
					if (_this2.state.isZoomed) {
						if (posY <= window.innerHeight / 2) {
							_this2.setState({ margin: window.innerHeight - posY + 'px 0 0 0' });
						} else {
							_this2.setState({ margin: '-' + posY / 1.3 + 'px 0 0 0' });
						}
					}
				});
			}
		...
		value: function renderImages() {
			...
			return React__default.createElement(
				...
				React__default.createElement(
					'div',
					{ className: aphrodite.css(this.classes.imageWrapper) },
					this.props.customMedia ? this.props.customMedia : React__default.createElement('img', {
					...
					this.props.content ? React__default.createElement(
						'figcaption',
						{
							className: aphrodite.css(this.classes.figcaption),
							style: {
		...
		value: function renderHeader() {
			var _props5 = this.props,
			    ...
			    showRotateButton = _props5.showRotateButton,
			    rotateButtonTitle = _props5.rotateButtonTitle;
		...
		get: function get$$1() {
			...
			return aphrodite.StyleSheet.create(deepMerge(defaultStyles, this.theme));
		}
	}]);
	return Lightbox;
}(React.Component);
...
var DefaultSpinner = function DefaultSpinner(props) {
	return React__default.createElement(undefined, props);
};
